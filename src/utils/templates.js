...
//     }
// }
const privateRoomTemplate = function(idA, idB, roomId, timestamp, message, encrypted){
    const roomDocPlain = {
        members:[idA, idB],
        type: 'private',
        messages:[],
        latestAction : {
            ...
            text: message,
            room: roomId,
            lastMessageType:'broadcast',
            timestamp: timestamp,
            senderName : '__'
        }
    };
    const roomDocEncrypted = {
        members:[idA, idB],
        type: 'private',
        messages:[],
        latestAction : {
    ...
    return {roomDocPlain, roomDocEncrypted, roomId};
}
const groupTemplate = function(name, timestamp, owner, message, encrypted){
